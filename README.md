...
|---------|-------------|-------|
| **[Transformer QA System](https://github.com/Harsha081459/Question-Answer-System-with-a-Custom-Transformer-Encoder-and-Generative-Decoder)** | End-to-end question answering system utilizing a custom encoder and generative decoder. | PyTorch, NLP |
| **[CLV Intelligence Engine](https://github.com/Harsha081459/clv-intelligence-engine)** | Predictive modeling engine built to accurately forecast Customer Lifetime Value. | Scikit-Learn, Pandas |
